...
run_simulation_grid(
  ...
  output_dir = file.path("output", "appendix_c1_quantile"),
  file_stub = "appendix_c1_quantile"
)
...
run_simulation_grid(
  ...
  gamma_vec = c(0, 0.15),
  cvm_weights = c("U", "Late", "Early", "Mid"),
  output_dir = file.path("output", "appendix_c1_expectile"),
  file_stub = "appendix_c1_expectile"
)
