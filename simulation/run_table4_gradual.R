...
cfg_gradual$instrument_type <- "z"

# Quantile monitoring + e-process benchmark
run_simulation_grid(
  config_grid = cfg_gradual,
  model_type = "quantile",
  ...
  output_dir = file.path("output", "table4_gradual_quantile"),
  file_stub = "table4_gradual_quantile"
)
...
run_simulation_grid(
  ...
  gamma_vec = c(0, 0.15),
  cvm_weights = c("U", "Late", "Early", "Mid"),
  output_dir = file.path("output", "table4_gradual_expectile"),
  file_stub = "table4_gradual_expectile"
)
